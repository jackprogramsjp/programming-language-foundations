...
(* THIS THEOREM IS NOT ON THE SOFTWARE FOUNDATIONS BUT IT IS EXTRA PRACTICE *)
Theorem skip_twice_left : forall c,
  cequiv
    <{ skip; skip; c }>
    c.
Proof.
...
Proof.
  ...
  - apply H1. assumption.
  - apply H2. assumption.
  - apply sym_cequiv in H1. apply H1. assumption.
  - apply sym_cequiv in H2. apply H2. assumption.
...
Proof.
  ...
  - (* while *)
    ...
    + apply trans_cequiv with <{ while true do skip end }>.
      * apply while_true.
        unfold bequiv in *.
        intros st.
        rewrite H.
